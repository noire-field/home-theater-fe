        ...
        <div className='flex flex-col justify-between h-screen p-3 md:p-10 text-shiro'>
            ...
            <div className='mb-10 md:mb-0 mt-0 flex flex-row justify-center'>
                <div className='flex flex-col w-500 h-115 justify-between'>
                    <div>
                        <p className='text-center text-2xl mb-5'>Dashboard Authentication</p>
                        <div className='flex flex-row justify-center mb-1'>
                            <div className='mr-2'>
                                <div className="relative">
                                    ...
                                    <input type="text" className="border border-kuro-5 rounded-lg block w-200 pl-10 p-2 bg-kuro-7 placeholder-kuro-4 text-shiro" placeholder="Admin's Password"/>
                                </div>
                            </div>
                            <div>
                                <button type="button" className="btn btn-blue"><i className="fa-solid fa-arrow-right-to-bracket mr-2"></i>Login</button>
                            </div>
                        </div>
